    ...
    return (
        <>
            {carregado && usuario && <main>
                <div className="h-100 bg-primary position-fixed w-100"></div>
                {/* MENU */}
                <aside className="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 offcanvas-lg" id="sidenav-main">
                    <div className="sidenav-header">
                        ...
                        <p className="navbar-brand m-0">
                            <span className="ms-1 font-weight-bold">GERENCIADOR</span>
                        </p>
                    </div>
                        ...
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link className={'nav-link ' + (url.includes('inicio') ? 'active' : '')} href="/admin/inicio">
                                    ...
                                    <span className="nav-link-text ms-1">Início</span>
                                </Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link className={'nav-link ' + (url.endsWith('usuarios') ? 'active' : '')} href="/admin/usuarios">
                                    <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                        <i className="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i>
                                    </div>
                            ...
                            <div className="row align-items-center justify-content-lg-between">
                                <div className="col-lg-6 mb-lg-0 mb-4">
                                    <p className="copyright text-center text-white text-sm text-lg-start">
                                        Template do CWG adaptado por Luiz
                                    </p>
                                </div>
                            </div>
                        </div>
